...
import illuDatasetSchema from './illu-dataset-schema.png';
...
The specification is also at [Apify documentation](https://docs.apify.com/platform/actors/development/actor-definition/output-schema).
