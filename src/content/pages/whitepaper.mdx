...
<Illustration description="Actors are designed to be easy to develop, share, integrate, and build upon." spline="illustrationplaceholder-23f5b5d3b0de25db8b9437eaaafb491c" position="wide" />
...
<Picture src={apifyActorDrawing} alt="Actor drawing" formats={['avif', 'webp']} class="is-wide" />
...
<Illustration description="Actors are designed for interoperability. Thanks to the input and output schemas, it easy to connect Actors with external systems, be it directly via REST API, Node.js or Python clients, CLI, or no-code automations." spline="illustrationplaceholder-23f5b5d3b0de25db8b9437eaaafb491c" position="wide" />
