...
import illuAPIChargingMoney from './illu-api-charging-money@2x.png';
...
import illuAPIMetamorph from './illu-api-metamorph@2x.png';
...
import illuDefinitionFilesInputSchemaFile from './illu-definition-files-input-schema-file@2x.gif';
...
import illuDiagram from './illu-diagram@2x.png';
...
<Illustration
    description="Actor programming model is language agnostic, but the framework has native support for detection of JavaScript and Python languages."
    position="right"
