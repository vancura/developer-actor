...
import illuApifyActor from './illu-apify-actor.png';
import illuInput from './illu-input.png';
import illuOutput from './illu-output.png';
import illuDocker from './illu-docker.png';
import illuStorage from './illu-storage.png';
import illuKeyValueStore from './illu-key-value-store.png';
import illuDataSet from './illu-dataset.png';
import illuIntegrations from './illu-integrations.png';
import illuWhyTheName from './illu-why-the-name.png';
import illuInitialization from './illu-initialization.png';
import illuGetInput from './illu-get-input.png';
import illuKeyValueStoreAccess from './illu-key-value-store-access.png';
import illuPushResultsToDataset from './illu-push-results-to-dataset.png';
import illuExitActor from './illu-exit-actor.png';
import illuStartAnotherActor from './illu-start-another-actor.png';
import illuMetamorph from './illu-metamorph.png';
...
<Picture src={illuApifyActor} alt="Actor drawing" formats={['avif', 'webp']} />
...
<Illustration description="The Actors run within an isolated Docker container" position="right" image={illuDocker} />
...
<Illustration description="Actors" position="content" image={illuWhyTheName} />
...
<Illustration
    description="The Key-value store is a storage for arbitrary files. When an Actor starts, by default it is associated with a newly-created key-value store, which only contains one file with input of the Actor."
    position="content"
    image={illuKeyValueStoreAccess}
/>
...
<Illustration
    description="The Dataset is an append-only storage that allows you to store a series of data objects such as results from web scraping, crawling, or data processing jobs."
    position="content"
    image={illuPushResultsToDataset}
/>
